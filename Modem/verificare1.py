...
if len(sM)==0:
    ...
    for [rb, k] in praguri_multiplicare:
        if Rb > rb:
            K = k
    print("Factorul de multiplicare al punctajului este: {:.1f}".format(K) )
    #modelel de canal
    #modeleCh = [chIdeal, chAWGN, chIntarziere, chMulticale, chAudio]
    ...
    for [modelCh, SNRdB, pt] in modeleCh:
        ...
        if rez==1:
            ...
            print("FAIL!")
        punctaj += rez*pt*K
        print("Punctaj intermediar: ", punctaj)
    
    print(sep2)
    print("Testele s-au finalizat")
    print("Punctajul obtinut: ", punctaj)
    print(sep2)
